...
def generate_launch_description():
    ...
    # Defaults spawn go2 on the flat paved apron in front of the cave's tunnel
    # entrance, facing into the tunnel (yaw=pi). The (0,0,0) world origin sits
    # inside the cave rock mesh and is not a safe spawn point.
    declare_world_init_x = DeclareLaunchArgument("world_init_x", default_value="8.0")
    declare_world_init_y = DeclareLaunchArgument("world_init_y", default_value="-20.5")
    ...
    set_gazebo_model_path = SetEnvironmentVariable(
        ...
        value=cave_models_path + ":" + os.environ.get("GAZEBO_MODEL_PATH", ""),
    )
